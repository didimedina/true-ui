import {
  ...
  import { mergeClasses } from '@true-ui/styles'
  import { type StyledComponent, isCssProperty, styled } from '@true-ui/styles/panda-codegen/jsx'
  ...
  export const createStyleContext = <R extends Recipe>(recipe: R) => {
        ...
        return (
          <StyleContext.Provider value={slotStyles}>
            <StyledComponent
              {...otherProps}
              ref={ref}
              className={mergeClasses(slotStyles?.[slot], props.className)}
            />
          </StyleContext.Provider>
        )
      })
    ...
    const withContext = <T, P extends { className?: string | undefined }>(
      ...
      const StyledSlotComponent = forwardRef<T, P>((props, ref) => {
        ...
        return (
          <StyledComponent {...props} ref={ref} className={mergeClasses(slotStyles?.[slot], props.className)} />
        )
      })
      // @ts-expect-error
